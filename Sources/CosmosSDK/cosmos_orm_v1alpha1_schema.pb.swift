...
/// StorageType
public enum Cosmos_Orm_V1alpha1_StorageType: SwiftProtobuf.Enum {
...
extension Cosmos_Orm_V1alpha1_StorageType: CaseIterable {
  ...
  public static var allCases: [Cosmos_Orm_V1alpha1_StorageType] = [
    .defaultUnspecified,
    .memory,
    .transient,
  ]
...
public struct Cosmos_Orm_V1alpha1_ModuleSchemaDescriptor {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var schemaFile: [Cosmos_Orm_V1alpha1_ModuleSchemaDescriptor.FileEntry] = []
  ...
  public struct FileEntry {
    ...
    public var protoFileName: String = String()

    /// storage_type optionally indicates the type of storage this file's
    /// tables should used. If it is left unspecified, the default KV-storage
    /// of the app will be used.
    public var storageType: Cosmos_Orm_V1alpha1_StorageType = .defaultUnspecified
...
extension SwiftProtobuf.Google_Protobuf_MessageOptions {
  ...
  /// option.
  public var Cosmos_Orm_V1alpha1_moduleSchema: Cosmos_Orm_V1alpha1_ModuleSchemaDescriptor {
  ...
  public var hasCosmos_Orm_V1alpha1_moduleSchema: Bool {
  ...
  public mutating func clearCosmos_Orm_V1alpha1_moduleSchema() {
...
public let Cosmos_Orm_V1alpha1_Schema_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
/// themselves as app module config messages using the cosmos.app.v1.is_module
/// option.
public let Cosmos_Orm_V1alpha1_Extensions_module_schema = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Cosmos_Orm_V1alpha1_ModuleSchemaDescriptor>, SwiftProtobuf.Google_Protobuf_MessageOptions>(
...
extension Cosmos_Orm_V1alpha1_ModuleSchemaDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ModuleSchemaDescriptor"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cosmos_Orm_V1alpha1_ModuleSchemaDescriptor, rhs: Cosmos_Orm_V1alpha1_ModuleSchemaDescriptor) -> Bool {
...
extension Cosmos_Orm_V1alpha1_ModuleSchemaDescriptor.FileEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = Cosmos_Orm_V1alpha1_ModuleSchemaDescriptor.protoMessageName + ".FileEntry"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "id"),
  ...
  public static func ==(lhs: Cosmos_Orm_V1alpha1_ModuleSchemaDescriptor.FileEntry, rhs: Cosmos_Orm_V1alpha1_ModuleSchemaDescriptor.FileEntry) -> Bool {
