...
public struct Cosmos_Bank_Module_V1_Module {
  ...
  public var blockedModuleAccountsOverride: [String] = []
...
extension Cosmos_Bank_Module_V1_Module: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Bank_Module_V1_Module, rhs: Cosmos_Bank_Module_V1_Module) -> Bool {
