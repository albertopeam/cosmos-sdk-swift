...
public struct Cosmos_App_Runtime_V1alpha1_Module {
  ...
  public var beginBlockers: [String] = []

  /// end_blockers specifies the module names of the end blockers
  /// to call in the order in which they should be called. If this is left empty
  /// no end blocker will be registered.
  public var endBlockers: [String] = []

  /// init_genesis specifies the module names of init genesis functions
  /// to call in the order in which they should be called. If this is left empty
  /// no init genesis function will be registered.
  public var initGenesis: [String] = []

  /// export_genesis specifies the order in which to export module genesis data.
  /// If this is left empty, the init_genesis order will be used for export genesis
  /// if it is specified.
  public var exportGenesis: [String] = []

  /// override_store_keys is an optional list of overrides for the module store keys
  /// to be used in keeper construction.
  public var overrideStoreKeys: [Cosmos_App_Runtime_V1alpha1_StoreKeyConfig] = []
  ...
  public var orderMigrations: [String] = []
...
/// is the module name.
public struct Cosmos_App_Runtime_V1alpha1_StoreKeyConfig {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var kvStoreKey: String = String()
...
extension Cosmos_App_Runtime_V1alpha1_Module: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_App_Runtime_V1alpha1_Module, rhs: Cosmos_App_Runtime_V1alpha1_Module) -> Bool {
...
extension Cosmos_App_Runtime_V1alpha1_StoreKeyConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".StoreKeyConfig"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cosmos_App_Runtime_V1alpha1_StoreKeyConfig, rhs: Cosmos_App_Runtime_V1alpha1_StoreKeyConfig) -> Bool {
