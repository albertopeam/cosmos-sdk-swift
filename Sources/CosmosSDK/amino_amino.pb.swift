...
extension SwiftProtobuf.Google_Protobuf_FieldOptions {
  ...
  public var Amino_encoding: String {
  ...
  /// `{"baz":"some value"}`
  public var Amino_fieldName: String {
  ...
  /// out == {"baz":""}
  public var Amino_dontOmitempty: Bool {
  ...
  /// has been explicitly set.
  public var hasAmino_dontOmitempty: Bool {
  ...
  /// Subsequent reads from it will return its default value.
  public mutating func clearAmino_dontOmitempty() {
  ...
  public var Amino_oneofName: String {
...
extension SwiftProtobuf.Google_Protobuf_MessageOptions {
  ...
  public var Amino_messageEncoding: String {
  ...
  /// has been explicitly set.
  public var hasAmino_messageEncoding: Bool {
  ...
  /// Subsequent reads from it will return its default value.
  public mutating func clearAmino_messageEncoding() {
...
public let Amino_Amino_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
/// characters long, or else the message will be rejected by the
/// Ledger hardware device.
public let Amino_Extensions_name = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufString>, SwiftProtobuf.Google_Protobuf_MessageOptions>(
...
/// This annotation should not be confused with the `encoding`
/// one which operates on the field level.
public let Amino_Extensions_message_encoding = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufString>, SwiftProtobuf.Google_Protobuf_MessageOptions>(
...
/// This annotation should not be confused with the
/// `message_encoding` one which operates on the message level.
public let Amino_Extensions_encoding = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufString>, SwiftProtobuf.Google_Protobuf_FieldOptions>(
...
/// Then the Amino encoding of Foo will be:
/// `{"baz":"some value"}`
public let Amino_Extensions_field_name = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufString>, SwiftProtobuf.Google_Protobuf_FieldOptions>(
...
/// out := AminoJSONEncoder(&f);
/// out == {"baz":""}
public let Amino_Extensions_dont_omitempty = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufBool>, SwiftProtobuf.Google_Protobuf_FieldOptions>(
...
/// by the Amino JSON encoder to encode the type of the oneof field, and must be the same string in
/// the RegisterConcrete() method usage used to register the concrete type.
public let Amino_Extensions_oneof_name = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalExtensionField<SwiftProtobuf.ProtobufString>, SwiftProtobuf.Google_Protobuf_FieldOptions>(
