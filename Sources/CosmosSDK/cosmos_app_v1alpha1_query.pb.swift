...
public struct Cosmos_App_V1alpha1_QueryConfigRequest {
...
public struct Cosmos_App_V1alpha1_QueryConfigResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// config is the current app config.
  public var config: Cosmos_App_V1alpha1_Config {
...
extension Cosmos_App_V1alpha1_QueryConfigRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryConfigRequest"
  ...
  public static func ==(lhs: Cosmos_App_V1alpha1_QueryConfigRequest, rhs: Cosmos_App_V1alpha1_QueryConfigRequest) -> Bool {
...
extension Cosmos_App_V1alpha1_QueryConfigResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryConfigResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "config"),
  ]
  ...
  public static func ==(lhs: Cosmos_App_V1alpha1_QueryConfigResponse, rhs: Cosmos_App_V1alpha1_QueryConfigResponse) -> Bool {
