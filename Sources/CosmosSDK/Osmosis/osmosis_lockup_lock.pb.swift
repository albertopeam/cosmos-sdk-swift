...
public enum Osmosis_Lockup_LockQueryType: SwiftProtobuf.Enum {
...
extension Osmosis_Lockup_LockQueryType: CaseIterable {
  ...
  public static var allCases: [Osmosis_Lockup_LockQueryType] = [
    .byDuration,
    .byTime,
  ]
}
...
public struct Osmosis_Lockup_PeriodLock {
...
/// LockQueryType.
public struct Osmosis_Lockup_QueryCondition {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// LockQueryType is a type of lock query, ByLockDuration | ByLockTime
  public var lockQueryType: Osmosis_Lockup_LockQueryType = .byDuration
...
public struct Osmosis_Lockup_SyntheticLock {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var underlyingLockID: UInt64 = 0

  /// SynthDenom is the synthetic denom that is a combination of
  /// gamm share + bonding status + validator address.
  public var synthDenom: String = String()
...
extension Osmosis_Lockup_PeriodLock: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PeriodLock"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "ID"),
    2: .same(proto: "owner"),
  ...
  public static func ==(lhs: Osmosis_Lockup_PeriodLock, rhs: Osmosis_Lockup_PeriodLock) -> Bool {
...
extension Osmosis_Lockup_QueryCondition: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryCondition"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Osmosis_Lockup_QueryCondition, rhs: Osmosis_Lockup_QueryCondition) -> Bool {
...
extension Osmosis_Lockup_SyntheticLock: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SyntheticLock"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Osmosis_Lockup_SyntheticLock, rhs: Osmosis_Lockup_SyntheticLock) -> Bool {
