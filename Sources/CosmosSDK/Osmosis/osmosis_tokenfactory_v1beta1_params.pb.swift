...
public struct Osmosis_Tokenfactory_V1beta1_Params {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var denomCreationFee: [Cosmos_Base_V1beta1_Coin] = []
...
extension Osmosis_Tokenfactory_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Tokenfactory_V1beta1_Params, rhs: Osmosis_Tokenfactory_V1beta1_Params) -> Bool {
