...
public struct Osmosis_Mint_V1beta1_Minter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// epoch_provisions represent rewards for the current epoch.
  public var epochProvisions: String = String()
...
public struct Osmosis_Mint_V1beta1_WeightedAddress {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// denoms and how much.
public struct Osmosis_Mint_V1beta1_DistributionProportions {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Osmosis_Mint_V1beta1_Params {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var genesisEpochProvisions: String = String()
  ...
  public var reductionPeriodInEpochs: Int64 = 0

  /// reduction_factor is the reduction multiplier to execute
  /// at the end of each period set by reduction_period_in_epochs.
  public var reductionFactor: String = String()

  /// distribution_proportions defines the distribution proportions of the minted
  /// denom. In other words, defines which stakeholders will receive the minted
  /// denoms and how much.
  public var distributionProportions: Osmosis_Mint_V1beta1_DistributionProportions {
  ...
  public var hasDistributionProportions: Bool {return self._distributionProportions != nil}
  /// Clears the value of `distributionProportions`. Subsequent reads from it will return its default value.
  public mutating func clearDistributionProportions() {self._distributionProportions = nil}
  ...
  public var weightedDeveloperRewardsReceivers: [Osmosis_Mint_V1beta1_WeightedAddress] = []

  /// minting_rewards_distribution_start_epoch start epoch to distribute minting
  /// rewards
  public var mintingRewardsDistributionStartEpoch: Int64 = 0
...
extension Osmosis_Mint_V1beta1_Minter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Mint_V1beta1_Minter, rhs: Osmosis_Mint_V1beta1_Minter) -> Bool {
...
extension Osmosis_Mint_V1beta1_WeightedAddress: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".WeightedAddress"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Osmosis_Mint_V1beta1_WeightedAddress, rhs: Osmosis_Mint_V1beta1_WeightedAddress) -> Bool {
...
extension Osmosis_Mint_V1beta1_DistributionProportions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DistributionProportions"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Osmosis_Mint_V1beta1_DistributionProportions, rhs: Osmosis_Mint_V1beta1_DistributionProportions) -> Bool {
...
extension Osmosis_Mint_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Mint_V1beta1_Params, rhs: Osmosis_Mint_V1beta1_Params) -> Bool {
