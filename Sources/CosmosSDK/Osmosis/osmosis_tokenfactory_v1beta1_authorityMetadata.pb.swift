...
public struct Osmosis_Tokenfactory_V1beta1_DenomAuthorityMetadata {
...
extension Osmosis_Tokenfactory_V1beta1_DenomAuthorityMetadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DenomAuthorityMetadata"
  ...
  public static func ==(lhs: Osmosis_Tokenfactory_V1beta1_DenomAuthorityMetadata, rhs: Osmosis_Tokenfactory_V1beta1_DenomAuthorityMetadata) -> Bool {
