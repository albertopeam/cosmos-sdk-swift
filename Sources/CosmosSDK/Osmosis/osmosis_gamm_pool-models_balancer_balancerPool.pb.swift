...
public struct Osmosis_Gamm_V1beta1_SmoothWeightChangeParams {
  ...
  /// here.
  public var initialPoolWeights: [Osmosis_Gamm_V1beta1_PoolAsset] = []

  /// The target pool weights. The pool weights will change linearly with respect
  /// to time between start_time, and start_time + duration. The amount
  /// PoolAsset.token.amount field is ignored if present, future type
  /// refactorings should just have a type with the denom & weight here.
  public var targetPoolWeights: [Osmosis_Gamm_V1beta1_PoolAsset] = []
...
public struct Osmosis_Gamm_V1beta1_PoolParams {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var exitFee: String = String()

  public var smoothWeightChangeParams: Osmosis_Gamm_V1beta1_SmoothWeightChangeParams {
  ...
  public var hasSmoothWeightChangeParams: Bool {return self._smoothWeightChangeParams != nil}
  /// Clears the value of `smoothWeightChangeParams`. Subsequent reads from it will return its default value.
  public mutating func clearSmoothWeightChangeParams() {self._smoothWeightChangeParams = nil}
...
public struct Osmosis_Gamm_V1beta1_PoolAsset {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Osmosis_Gamm_V1beta1_Pool {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var poolParams: Osmosis_Gamm_V1beta1_PoolParams {
  ...
  public var poolAssets: [Osmosis_Gamm_V1beta1_PoolAsset] = []
...
extension Osmosis_Gamm_V1beta1_SmoothWeightChangeParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SmoothWeightChangeParams"
  ...
  public static func ==(lhs: Osmosis_Gamm_V1beta1_SmoothWeightChangeParams, rhs: Osmosis_Gamm_V1beta1_SmoothWeightChangeParams) -> Bool {
...
extension Osmosis_Gamm_V1beta1_PoolParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PoolParams"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Osmosis_Gamm_V1beta1_PoolParams, rhs: Osmosis_Gamm_V1beta1_PoolParams) -> Bool {
...
extension Osmosis_Gamm_V1beta1_PoolAsset: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PoolAsset"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "token"),
    2: .same(proto: "weight"),
  ]
  ...
  public static func ==(lhs: Osmosis_Gamm_V1beta1_PoolAsset, rhs: Osmosis_Gamm_V1beta1_PoolAsset) -> Bool {
...
extension Osmosis_Gamm_V1beta1_Pool: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Gamm_V1beta1_Pool, rhs: Osmosis_Gamm_V1beta1_Pool) -> Bool {
