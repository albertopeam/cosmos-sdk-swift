...
public struct Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_PoolParams {
...
public struct Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_Pool {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// assets in the pool
  public var poolLiquidity: [Cosmos_Base_V1beta1_Coin] = []
...
extension Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_PoolParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_PoolParams, rhs: Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_PoolParams) -> Bool {
...
extension Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_Pool: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_Pool, rhs: Osmosis_Gamm_Poolmodels_Stableswap_V1beta1_Pool) -> Bool {
