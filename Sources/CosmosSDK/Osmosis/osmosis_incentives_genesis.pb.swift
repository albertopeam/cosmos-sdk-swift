...
/// initialized
public struct Osmosis_Incentives_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// params are all the parameters of the module
  public var params: Osmosis_Incentives_Params {
  ...
  public var gauges: [Osmosis_Incentives_Gauge] = []
  ...
  public var lastGaugeID: UInt64 = 0
...
extension Osmosis_Incentives_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Incentives_GenesisState, rhs: Osmosis_Incentives_GenesisState) -> Bool {
