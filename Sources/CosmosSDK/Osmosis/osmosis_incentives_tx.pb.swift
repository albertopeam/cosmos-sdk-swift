...
public struct Osmosis_Incentives_MsgCreateGauge {
  ...
  public var distributeTo: Osmosis_Lockup_QueryCondition {
  ...
  public var hasDistributeTo: Bool {return self._distributeTo != nil}
  /// Clears the value of `distributeTo`. Subsequent reads from it will return its default value.
  public mutating func clearDistributeTo() {self._distributeTo = nil}
  ...
  /// over
  public var numEpochsPaidOver: UInt64 = 0
...
public struct Osmosis_Incentives_MsgCreateGaugeResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Osmosis_Incentives_MsgAddToGauge {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var rewards: [Cosmos_Base_V1beta1_Coin] = []
...
public struct Osmosis_Incentives_MsgAddToGaugeResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Osmosis_Incentives_MsgCreateGauge: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MsgCreateGauge"
  ...
  public static func ==(lhs: Osmosis_Incentives_MsgCreateGauge, rhs: Osmosis_Incentives_MsgCreateGauge) -> Bool {
...
extension Osmosis_Incentives_MsgCreateGaugeResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MsgCreateGaugeResponse"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Osmosis_Incentives_MsgCreateGaugeResponse, rhs: Osmosis_Incentives_MsgCreateGaugeResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Osmosis_Incentives_MsgAddToGauge: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MsgAddToGauge"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "owner"),
  ...
  public static func ==(lhs: Osmosis_Incentives_MsgAddToGauge, rhs: Osmosis_Incentives_MsgAddToGauge) -> Bool {
    if lhs.owner != rhs.owner {return false}
...
extension Osmosis_Incentives_MsgAddToGaugeResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MsgAddToGaugeResponse"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Osmosis_Incentives_MsgAddToGaugeResponse, rhs: Osmosis_Incentives_MsgAddToGaugeResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
