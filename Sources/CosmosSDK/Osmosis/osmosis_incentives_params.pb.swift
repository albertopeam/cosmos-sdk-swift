...
public struct Osmosis_Incentives_Params {
  ...
  /// (day, week, etc.)
  public var distrEpochIdentifier: String = String()
...
extension Osmosis_Incentives_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Incentives_Params, rhs: Osmosis_Incentives_Params) -> Bool {
