...
public struct Osmosis_Txfees_V1beta1_UpdateFeeTokenProposal {
  ...
  public var feetoken: Osmosis_Txfees_V1beta1_FeeToken {
  ...
  public var hasFeetoken: Bool {return self._feetoken != nil}
  /// Clears the value of `feetoken`. Subsequent reads from it will return its default value.
  public mutating func clearFeetoken() {self._feetoken = nil}
...
extension Osmosis_Txfees_V1beta1_UpdateFeeTokenProposal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".UpdateFeeTokenProposal"
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._feetoken {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: Osmosis_Txfees_V1beta1_UpdateFeeTokenProposal, rhs: Osmosis_Txfees_V1beta1_UpdateFeeTokenProposal) -> Bool {
