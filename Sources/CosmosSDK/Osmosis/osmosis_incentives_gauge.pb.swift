...
public struct Osmosis_Incentives_Gauge {
  ...
  /// already
  public var filledEpochs: UInt64 = 0

  /// distributed_coins are coins that have been distributed already
  public var distributedCoins: [Cosmos_Base_V1beta1_Coin] = []
...
public struct Osmosis_Incentives_LockableDurationsInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Osmosis_Incentives_Gauge: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Incentives_Gauge, rhs: Osmosis_Incentives_Gauge) -> Bool {
...
extension Osmosis_Incentives_LockableDurationsInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Incentives_LockableDurationsInfo, rhs: Osmosis_Incentives_LockableDurationsInfo) -> Bool {
