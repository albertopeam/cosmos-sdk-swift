...
public struct Osmosis_Epochs_V1beta1_EpochInfo {
...
public struct Osmosis_Epochs_V1beta1_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Osmosis_Epochs_V1beta1_EpochInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Epochs_V1beta1_EpochInfo, rhs: Osmosis_Epochs_V1beta1_EpochInfo) -> Bool {
...
extension Osmosis_Epochs_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Epochs_V1beta1_GenesisState, rhs: Osmosis_Epochs_V1beta1_GenesisState) -> Bool {
