...
public struct Osmosis_Mint_V1beta1_QueryParamsRequest {
...
public struct Osmosis_Mint_V1beta1_QueryParamsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// params defines the parameters of the module.
  public var params: Osmosis_Mint_V1beta1_Params {
...
public struct Osmosis_Mint_V1beta1_QueryEpochProvisionsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Query/EpochProvisions RPC method.
public struct Osmosis_Mint_V1beta1_QueryEpochProvisionsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// epoch_provisions is the current minting per epoch provisions value.
  public var epochProvisions: Data = Data()
...
extension Osmosis_Mint_V1beta1_QueryParamsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Mint_V1beta1_QueryParamsRequest, rhs: Osmosis_Mint_V1beta1_QueryParamsRequest) -> Bool {
...
extension Osmosis_Mint_V1beta1_QueryParamsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Mint_V1beta1_QueryParamsResponse, rhs: Osmosis_Mint_V1beta1_QueryParamsResponse) -> Bool {
...
extension Osmosis_Mint_V1beta1_QueryEpochProvisionsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryEpochProvisionsRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap()
  ...
  public static func ==(lhs: Osmosis_Mint_V1beta1_QueryEpochProvisionsRequest, rhs: Osmosis_Mint_V1beta1_QueryEpochProvisionsRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Osmosis_Mint_V1beta1_QueryEpochProvisionsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryEpochProvisionsResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Osmosis_Mint_V1beta1_QueryEpochProvisionsResponse, rhs: Osmosis_Mint_V1beta1_QueryEpochProvisionsResponse) -> Bool {
