...
public struct Osmosis_Mint_V1beta1_GenesisState {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// minter is an abstraction for holding current rewards information.
  public var minter: Osmosis_Mint_V1beta1_Minter {
  ...
  /// begins.
  public var reductionStartedEpoch: Int64 = 0
...
extension Osmosis_Mint_V1beta1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Mint_V1beta1_GenesisState, rhs: Osmosis_Mint_V1beta1_GenesisState) -> Bool {
