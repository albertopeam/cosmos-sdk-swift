...
/// ===================== MsgCreatePool
public struct Osmosis_Gamm_Poolmodels_Balancer_V1beta1_MsgCreateBalancerPool {
...
/// Returns the poolID
public struct Osmosis_Gamm_Poolmodels_Balancer_V1beta1_MsgCreateBalancerPoolResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Osmosis_Gamm_Poolmodels_Balancer_V1beta1_MsgCreateBalancerPool: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MsgCreateBalancerPool"
  ...
  public static func ==(lhs: Osmosis_Gamm_Poolmodels_Balancer_V1beta1_MsgCreateBalancerPool, rhs: Osmosis_Gamm_Poolmodels_Balancer_V1beta1_MsgCreateBalancerPool) -> Bool {
...
extension Osmosis_Gamm_Poolmodels_Balancer_V1beta1_MsgCreateBalancerPoolResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MsgCreateBalancerPoolResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Osmosis_Gamm_Poolmodels_Balancer_V1beta1_MsgCreateBalancerPoolResponse, rhs: Osmosis_Gamm_Poolmodels_Balancer_V1beta1_MsgCreateBalancerPoolResponse) -> Bool {
