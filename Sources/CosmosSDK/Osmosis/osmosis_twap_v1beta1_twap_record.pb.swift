...
/// now.
public struct Osmosis_Twap_V1beta1_TwapRecord {
  ...
  public var asset0Denom: String = String()

  /// Lexicographically larger denom of the pair
  public var asset1Denom: String = String()
  ...
  public var p0LastSpotPrice: String = String()

  public var p1LastSpotPrice: String = String()

  public var p0ArithmeticTwapAccumulator: String = String()

  /// string geometric_twap_accumulator = 7 [(gogoproto.customtype) =
  /// "github.com/cosmos/cosmos-sdk/types.Dec",
  /// (gogoproto.nullable) = false];
  public var p1ArithmeticTwapAccumulator: String = String()
  ...
  public var hasLastErrorTime: Bool {return self._lastErrorTime != nil}
  /// Clears the value of `lastErrorTime`. Subsequent reads from it will return its default value.
  public mutating func clearLastErrorTime() {self._lastErrorTime = nil}
...
extension Osmosis_Twap_V1beta1_TwapRecord: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TwapRecord"
  ...
  public static func ==(lhs: Osmosis_Twap_V1beta1_TwapRecord, rhs: Osmosis_Twap_V1beta1_TwapRecord) -> Bool {
