...
public struct Osmosis_Store_V1beta1_Node {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var children: [Osmosis_Store_V1beta1_Child] = []
...
public struct Osmosis_Store_V1beta1_Child {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var index: Data = Data()

  public var accumulation: String = String()
...
public struct Osmosis_Store_V1beta1_Leaf {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var leaf: Osmosis_Store_V1beta1_Child {
...
extension Osmosis_Store_V1beta1_Node: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Store_V1beta1_Node, rhs: Osmosis_Store_V1beta1_Node) -> Bool {
...
extension Osmosis_Store_V1beta1_Child: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Store_V1beta1_Child, rhs: Osmosis_Store_V1beta1_Child) -> Bool {
...
extension Osmosis_Store_V1beta1_Leaf: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Osmosis_Store_V1beta1_Leaf, rhs: Osmosis_Store_V1beta1_Leaf) -> Bool {
