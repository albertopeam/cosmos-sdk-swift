...
/// assets
public struct Osmosis_Superfluid_V1beta1_SetSuperfluidAssetsProposal {
...
/// assets by denom
public struct Osmosis_Superfluid_V1beta1_RemoveSuperfluidAssetsProposal {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var superfluidAssetDenoms: [String] = []
...
extension Osmosis_Superfluid_V1beta1_SetSuperfluidAssetsProposal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SetSuperfluidAssetsProposal"
  ...
  public static func ==(lhs: Osmosis_Superfluid_V1beta1_SetSuperfluidAssetsProposal, rhs: Osmosis_Superfluid_V1beta1_SetSuperfluidAssetsProposal) -> Bool {
...
extension Osmosis_Superfluid_V1beta1_RemoveSuperfluidAssetsProposal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RemoveSuperfluidAssetsProposal"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "title"),
    2: .same(proto: "description"),
  ...
  public static func ==(lhs: Osmosis_Superfluid_V1beta1_RemoveSuperfluidAssetsProposal, rhs: Osmosis_Superfluid_V1beta1_RemoveSuperfluidAssetsProposal) -> Bool {
    if lhs.title != rhs.title {return false}
    if lhs.description_p != rhs.description_p {return false}
