...
public struct Cosmos_Authz_V1beta1_QueryGranterGrantsResponse {
  ...
  public var grants: [Cosmos_Authz_V1beta1_GrantAuthorization] = []
...
public struct Cosmos_Authz_V1beta1_QueryGranteeGrantsRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cosmos_Authz_V1beta1_QueryGranteeGrantsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmos_Authz_V1beta1_QueryGranteeGrantsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryGranteeGrantsRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cosmos_Authz_V1beta1_QueryGranteeGrantsRequest, rhs: Cosmos_Authz_V1beta1_QueryGranteeGrantsRequest) -> Bool {
    if lhs.grantee != rhs.grantee {return false}
    if lhs._pagination != rhs._pagination {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Cosmos_Authz_V1beta1_QueryGranteeGrantsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryGranteeGrantsResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "grants"),
    2: .same(proto: "pagination"),
  ]
  ...
  public static func ==(lhs: Cosmos_Authz_V1beta1_QueryGranteeGrantsResponse, rhs: Cosmos_Authz_V1beta1_QueryGranteeGrantsResponse) -> Bool {
    if lhs.grants != rhs.grants {return false}
    if lhs._pagination != rhs._pagination {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
