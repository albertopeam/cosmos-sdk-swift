...
public struct Cosmos_Bank_V1beta1_Params {
...
/// sendable).
public struct Cosmos_Bank_V1beta1_SendEnabled {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cosmos_Bank_V1beta1_Supply {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var total: [Cosmos_Base_V1beta1_Coin] = []
...
public struct Cosmos_Bank_V1beta1_DenomUnit {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// a basic token.
public struct Cosmos_Bank_V1beta1_Metadata {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var denomUnits: [Cosmos_Bank_V1beta1_DenomUnit] = []
...
extension Cosmos_Bank_V1beta1_Params: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Bank_V1beta1_Params, rhs: Cosmos_Bank_V1beta1_Params) -> Bool {
...
extension Cosmos_Bank_V1beta1_SendEnabled: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SendEnabled"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "denom"),
  ...
  public static func ==(lhs: Cosmos_Bank_V1beta1_SendEnabled, rhs: Cosmos_Bank_V1beta1_SendEnabled) -> Bool {
...
extension Cosmos_Bank_V1beta1_Supply: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Bank_V1beta1_Supply, rhs: Cosmos_Bank_V1beta1_Supply) -> Bool {
...
extension Cosmos_Bank_V1beta1_DenomUnit: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DenomUnit"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "denom"),
  ...
  public static func ==(lhs: Cosmos_Bank_V1beta1_DenomUnit, rhs: Cosmos_Bank_V1beta1_DenomUnit) -> Bool {
    if lhs.denom != rhs.denom {return false}
...
extension Cosmos_Bank_V1beta1_Metadata: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Bank_V1beta1_Metadata, rhs: Cosmos_Bank_V1beta1_Metadata) -> Bool {
