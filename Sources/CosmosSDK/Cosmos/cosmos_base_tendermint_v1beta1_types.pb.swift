...
public struct Cosmos_Base_Tendermint_V1beta1_Block {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var header: Cosmos_Base_Tendermint_V1beta1_Header {
...
public struct Cosmos_Base_Tendermint_V1beta1_Header {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// for better UX.
  public var proposerAddress: String {
...
extension Cosmos_Base_Tendermint_V1beta1_Block: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Base_Tendermint_V1beta1_Block, rhs: Cosmos_Base_Tendermint_V1beta1_Block) -> Bool {
...
extension Cosmos_Base_Tendermint_V1beta1_Header: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Base_Tendermint_V1beta1_Header, rhs: Cosmos_Base_Tendermint_V1beta1_Header) -> Bool {
