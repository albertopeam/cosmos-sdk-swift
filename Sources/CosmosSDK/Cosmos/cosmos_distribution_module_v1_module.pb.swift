...
public struct Cosmos_Distribution_Module_V1_Module {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var feeCollectorName: String = String()
...
extension Cosmos_Distribution_Module_V1_Module: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Distribution_Module_V1_Module, rhs: Cosmos_Distribution_Module_V1_Module) -> Bool {
