...
public struct Cosmos_Group_V1_GenesisState {
  ...
  public var groupSeq: UInt64 = 0

  /// groups is the list of groups info.
  public var groups: [Cosmos_Group_V1_GroupInfo] = []

  /// group_members is the list of groups members.
  public var groupMembers: [Cosmos_Group_V1_GroupMember] = []

  /// group_policy_seq is the group policy table orm.Sequence,
  /// it is used to generate the next group policy account address.
  public var groupPolicySeq: UInt64 = 0
  ...
  public var proposalSeq: UInt64 = 0
...
extension Cosmos_Group_V1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Group_V1_GenesisState, rhs: Cosmos_Group_V1_GenesisState) -> Bool {
