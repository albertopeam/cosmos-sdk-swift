...
public struct Cosmos_App_V1alpha1_ModuleDescriptor {
  ...
  public var goImport: String = String()

  /// use_package refers to a protobuf package that this module
  /// uses and exposes to the world. In an app, only one module should "use"
  /// or own a single protobuf package. It is assumed that the module uses
  /// all of the .proto files in a single package.
  public var usePackage: [Cosmos_App_V1alpha1_PackageReference] = []
  ...
  public var canMigrateFrom: [Cosmos_App_V1alpha1_MigrateFromInfo] = []
...
public struct Cosmos_App_V1alpha1_PackageReference {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// can migrate from.
public struct Cosmos_App_V1alpha1_MigrateFromInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension SwiftProtobuf.Google_Protobuf_MessageOptions {
  ...
  public var Cosmos_App_V1alpha1_module: Cosmos_App_V1alpha1_ModuleDescriptor {
  ...
  public var hasCosmos_App_V1alpha1_module: Bool {
  ...
  public mutating func clearCosmos_App_V1alpha1_module() {
...
public let Cosmos_App_V1alpha1_Module_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
/// package from the API they expose. Ex: the cosmos.group.v1 API would be
/// exposed by module configs cosmos.group.module.v1, cosmos.group.module.v2, etc.
public let Cosmos_App_V1alpha1_Extensions_module = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Cosmos_App_V1alpha1_ModuleDescriptor>, SwiftProtobuf.Google_Protobuf_MessageOptions>(
...
extension Cosmos_App_V1alpha1_ModuleDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ModuleDescriptor"
  ...
  public static func ==(lhs: Cosmos_App_V1alpha1_ModuleDescriptor, rhs: Cosmos_App_V1alpha1_ModuleDescriptor) -> Bool {
...
extension Cosmos_App_V1alpha1_PackageReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_App_V1alpha1_PackageReference, rhs: Cosmos_App_V1alpha1_PackageReference) -> Bool {
...
extension Cosmos_App_V1alpha1_MigrateFromInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MigrateFromInfo"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "module"),
  ]
  ...
  public static func ==(lhs: Cosmos_App_V1alpha1_MigrateFromInfo, rhs: Cosmos_App_V1alpha1_MigrateFromInfo) -> Bool {
