...
public struct Cosmos_Store_Internal_Kv_V1beta1_Pairs {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var pairs: [Cosmos_Store_Internal_Kv_V1beta1_Pair] = []
...
public struct Cosmos_Store_Internal_Kv_V1beta1_Pair {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmos_Store_Internal_Kv_V1beta1_Pairs: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Store_Internal_Kv_V1beta1_Pairs, rhs: Cosmos_Store_Internal_Kv_V1beta1_Pairs) -> Bool {
...
extension Cosmos_Store_Internal_Kv_V1beta1_Pair: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Store_Internal_Kv_V1beta1_Pair, rhs: Cosmos_Store_Internal_Kv_V1beta1_Pair) -> Bool {
