...
public enum Cosmos_Group_V1_VoteOption: SwiftProtobuf.Enum {
...
extension Cosmos_Group_V1_VoteOption: CaseIterable {
  ...
  public static var allCases: [Cosmos_Group_V1_VoteOption] = [
    .unspecified,
    .yes,
    .abstain,
    .no,
...
public enum Cosmos_Group_V1_ProposalStatus: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Cosmos_Group_V1_ProposalStatus: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Cosmos_Group_V1_ProposalStatus] = [
    .unspecified,
    .submitted,
    .accepted,
    .rejected,
...
public enum Cosmos_Group_V1_ProposalExecutorResult: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Cosmos_Group_V1_ProposalExecutorResult: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static var allCases: [Cosmos_Group_V1_ProposalExecutorResult] = [
    .unspecified,
    .notRun,
    .success,
    .failure,
...
public struct Cosmos_Group_V1_Member {
  ...
  public var hasAddedAt: Bool {return self._addedAt != nil}
...
public struct Cosmos_Group_V1_MemberRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///    given by `windows`.
public struct Cosmos_Group_V1_ThresholdDecisionPolicy {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var windows: Cosmos_Group_V1_DecisionPolicyWindows {
...
/// 2. The voting and execution periods of the proposal respect the parameters
///    given by `windows`.
public struct Cosmos_Group_V1_PercentageDecisionPolicy {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cosmos_Group_V1_DecisionPolicyWindows {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var minExecutionPeriod: SwiftProtobuf.Google_Protobuf_Duration {
  ...
  public var hasMinExecutionPeriod: Bool {return self._minExecutionPeriod != nil}
  /// Clears the value of `minExecutionPeriod`. Subsequent reads from it will return its default value.
  public mutating func clearMinExecutionPeriod() {self._minExecutionPeriod = nil}
...
public struct Cosmos_Group_V1_GroupInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cosmos_Group_V1_GroupMember {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var member: Cosmos_Group_V1_Member {
...
public struct Cosmos_Group_V1_GroupPolicyInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cosmos_Group_V1_Proposal {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var groupPolicyAddress: String {
  ...
  public var finalTallyResult: Cosmos_Group_V1_TallyResult {
  ...
  /// accordingly updated.
  public var votingPeriodEnd: SwiftProtobuf.Google_Protobuf_Timestamp {
  ...
  public var hasVotingPeriodEnd: Bool {return _storage._votingPeriodEnd != nil}
  /// Clears the value of `votingPeriodEnd`. Subsequent reads from it will return its default value.
  public mutating func clearVotingPeriodEnd() {_uniqueStorage()._votingPeriodEnd = nil}

  /// executor_result is the final result of the proposal execution. Initial value is NotRun.
  public var executorResult: Cosmos_Group_V1_ProposalExecutorResult {
...
public struct Cosmos_Group_V1_TallyResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Cosmos_Group_V1_Vote {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmos_Group_V1_Member: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Group_V1_Member, rhs: Cosmos_Group_V1_Member) -> Bool {
...
extension Cosmos_Group_V1_MemberRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MemberRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "address"),
    2: .same(proto: "weight"),
    3: .same(proto: "metadata"),
  ...
  public static func ==(lhs: Cosmos_Group_V1_MemberRequest, rhs: Cosmos_Group_V1_MemberRequest) -> Bool {
    if lhs.address != rhs.address {return false}
    if lhs.weight != rhs.weight {return false}
    if lhs.metadata != rhs.metadata {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Cosmos_Group_V1_ThresholdDecisionPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Group_V1_ThresholdDecisionPolicy, rhs: Cosmos_Group_V1_ThresholdDecisionPolicy) -> Bool {
...
extension Cosmos_Group_V1_PercentageDecisionPolicy: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PercentageDecisionPolicy"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cosmos_Group_V1_PercentageDecisionPolicy, rhs: Cosmos_Group_V1_PercentageDecisionPolicy) -> Bool {
...
extension Cosmos_Group_V1_DecisionPolicyWindows: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".DecisionPolicyWindows"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cosmos_Group_V1_DecisionPolicyWindows, rhs: Cosmos_Group_V1_DecisionPolicyWindows) -> Bool {
...
extension Cosmos_Group_V1_GroupInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Group_V1_GroupInfo, rhs: Cosmos_Group_V1_GroupInfo) -> Bool {
...
extension Cosmos_Group_V1_GroupMember: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Group_V1_GroupMember, rhs: Cosmos_Group_V1_GroupMember) -> Bool {
...
extension Cosmos_Group_V1_GroupPolicyInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GroupPolicyInfo"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "address"),
  ...
  public static func ==(lhs: Cosmos_Group_V1_GroupPolicyInfo, rhs: Cosmos_Group_V1_GroupPolicyInfo) -> Bool {
    if lhs.address != rhs.address {return false}
    if lhs.groupID != rhs.groupID {return false}
    if lhs.admin != rhs.admin {return false}
    if lhs.metadata != rhs.metadata {return false}
...
extension Cosmos_Group_V1_Proposal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Group_V1_Proposal, rhs: Cosmos_Group_V1_Proposal) -> Bool {
...
extension Cosmos_Group_V1_TallyResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Group_V1_TallyResult, rhs: Cosmos_Group_V1_TallyResult) -> Bool {
...
extension Cosmos_Group_V1_Vote: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Group_V1_Vote, rhs: Cosmos_Group_V1_Vote) -> Bool {
