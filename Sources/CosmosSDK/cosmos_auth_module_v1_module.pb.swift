...
public struct Cosmos_Auth_Module_V1_Module {
  ...
  public var moduleAccountPermissions: [Cosmos_Auth_Module_V1_ModuleAccountPermission] = []
...
public struct Cosmos_Auth_Module_V1_ModuleAccountPermission {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmos_Auth_Module_V1_Module: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Cosmos_Auth_Module_V1_Module, rhs: Cosmos_Auth_Module_V1_Module) -> Bool {
...
extension Cosmos_Auth_Module_V1_ModuleAccountPermission: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".ModuleAccountPermission"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: Cosmos_Auth_Module_V1_ModuleAccountPermission, rhs: Cosmos_Auth_Module_V1_ModuleAccountPermission) -> Bool {
