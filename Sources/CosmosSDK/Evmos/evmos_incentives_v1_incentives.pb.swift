...
public struct Evmos_Incentives_V1_Incentive {
  ...
  public var allocations: [Cosmos_Base_V1beta1_DecCoin] = []

  /// epochs defines the number of remaining epochs for the incentive
  public var epochs: UInt32 = 0
...
public struct Evmos_Incentives_V1_GasMeter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var cumulativeGas: UInt64 = 0
...
public struct Evmos_Incentives_V1_RegisterIncentiveProposal {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Evmos_Incentives_V1_CancelIncentiveProposal {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Evmos_Incentives_V1_Incentive: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Incentive"
  ...
  public static func ==(lhs: Evmos_Incentives_V1_Incentive, rhs: Evmos_Incentives_V1_Incentive) -> Bool {
...
extension Evmos_Incentives_V1_GasMeter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GasMeter"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "contract"),
  ...
  public static func ==(lhs: Evmos_Incentives_V1_GasMeter, rhs: Evmos_Incentives_V1_GasMeter) -> Bool {
    if lhs.contract != rhs.contract {return false}
...
extension Evmos_Incentives_V1_RegisterIncentiveProposal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RegisterIncentiveProposal"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "title"),
  ...
  public static func ==(lhs: Evmos_Incentives_V1_RegisterIncentiveProposal, rhs: Evmos_Incentives_V1_RegisterIncentiveProposal) -> Bool {
...
extension Evmos_Incentives_V1_CancelIncentiveProposal: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".CancelIncentiveProposal"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "title"),
    2: .same(proto: "description"),
    3: .same(proto: "contract"),
  ...
  public static func ==(lhs: Evmos_Incentives_V1_CancelIncentiveProposal, rhs: Evmos_Incentives_V1_CancelIncentiveProposal) -> Bool {
    if lhs.title != rhs.title {return false}
    if lhs.description_p != rhs.description_p {return false}
    if lhs.contract != rhs.contract {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
