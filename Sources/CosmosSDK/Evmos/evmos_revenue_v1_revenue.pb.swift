...
public struct Evmos_Revenue_V1_Revenue {
...
extension Evmos_Revenue_V1_Revenue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Revenue"
  ...
  public static func ==(lhs: Evmos_Revenue_V1_Revenue, rhs: Evmos_Revenue_V1_Revenue) -> Bool {
