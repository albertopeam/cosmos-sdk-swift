...
public struct Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///
/// Since: cosmos-sdk 0.46
public struct Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryAllowancesByGranterRequest"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "granter"),
    2: .same(proto: "pagination"),
  ]
  ...
  public static func ==(lhs: Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterRequest, rhs: Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterRequest) -> Bool {
    if lhs.granter != rhs.granter {return false}
    if lhs._pagination != rhs._pagination {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
...
extension Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".QueryAllowancesByGranterResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "allowances"),
    2: .same(proto: "pagination"),
  ]
  ...
  public static func ==(lhs: Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterResponse, rhs: Cosmos_Feegrant_V1beta1_QueryAllowancesByGranterResponse) -> Bool {
    if lhs.allowances != rhs.allowances {return false}
    if lhs._pagination != rhs._pagination {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
