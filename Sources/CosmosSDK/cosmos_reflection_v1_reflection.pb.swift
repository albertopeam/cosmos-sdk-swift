...
public struct Cosmos_Reflection_V1_FileDescriptorsRequest {
...
public struct Cosmos_Reflection_V1_FileDescriptorsResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// files is the file descriptors.
  public var files: [SwiftProtobuf.Google_Protobuf_FileDescriptorProto] = []
...
extension Cosmos_Reflection_V1_FileDescriptorsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".FileDescriptorsRequest"
  ...
  public static func ==(lhs: Cosmos_Reflection_V1_FileDescriptorsRequest, rhs: Cosmos_Reflection_V1_FileDescriptorsRequest) -> Bool {
...
extension Cosmos_Reflection_V1_FileDescriptorsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".FileDescriptorsResponse"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "files"),
  ]
  ...
  public static func ==(lhs: Cosmos_Reflection_V1_FileDescriptorsResponse, rhs: Cosmos_Reflection_V1_FileDescriptorsResponse) -> Bool {
